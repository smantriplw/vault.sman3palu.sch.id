  ...
  const downloadExport = async () => {
    ...
    try {
      ...
      if (passphrase) {
        ...
        filename = `smantivault-export-${date}.json.encrypted`;
      } else {
        content = JSON.stringify(data, null, 2);
        filename = `smantivault-export-${date}.json`;
      }
  ...
  return (
    <Layout>
      <div className="max-w-lg mx-auto">
        <h1 className="text-xl font-semibold text-gray-900 mb-6">Export Vault</h1>
            ...
            {data && (
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">{data.uris.length} TOTP entries</p>
                ...
                <div className="border-t border-gray-100 pt-4 space-y-3">
                  ...
                  <p className="text-xs text-gray-400">
                    {passphrase
                      ...
                      : "Without encryption, the export file will contain raw otpauth:// URIs."}
                  </p>
                </div>
                ...
                >
                  {encrypting ? (
                    ...
                    <>
                      ...
                      {passphrase ? "Encrypt & Download" : "Download Export"}
                    </>
                  )}
                </button>
              </div>
        ...
        <button onClick={() => navigate("/")} className="btn-secondary w-full mt-4 justify-center">
          Back to Vault
        </button>
      </div>
    </Layout>
